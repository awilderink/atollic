...
- Name: children.spec.ts >> Children >> cross-framework: React outer with Solid inner hydrates both
- Location: e2e/children.spec.ts:50:2
...
Locator:  getByTestId('react-children-content').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByTestId('react-children-content').first()
    9 × locator resolved to <div data-testid="react-children-content"></div>
