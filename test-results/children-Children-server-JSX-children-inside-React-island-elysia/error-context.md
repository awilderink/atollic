...
- Name: children.spec.ts >> Children >> server JSX children inside React island
- Location: e2e/children.spec.ts:45:2
...
Locator: getByTestId('react-jsx-children').locator('p')
Expected substring: "Paragraph rendered"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for getByTestId('react-jsx-children').locator('p')
