...
- Name: state.spec.ts >> Cross-island State >> clicking toggle again hides the panel
- Location: e2e/state.spec.ts:24:2
...
Call log:
  - waiting for getByRole('button', { name: /hide panel/i })
