...
- Name: children.spec.ts >> Children >> async server children resolve inside Solid island
- Location: e2e/children.spec.ts:34:2
...
Locator: getByTestId('solid-async-children').getByTestId('async-content')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('solid-async-children').getByTestId('async-content')
