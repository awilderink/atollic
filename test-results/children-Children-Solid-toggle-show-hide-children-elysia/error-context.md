...
- Name: children.spec.ts >> Children >> Solid toggle show/hide children
- Location: e2e/children.spec.ts:19:2
...
Locator: getByTestId('solid-children-content')
Expected: visible
Error: strict mode violation: getByTestId('solid-children-content') resolved to 3 elements:
    1) <div data-testid="solid-children-content" data-hk="ix-SolidChildrenShowcase-61">…</div> aka getByTestId('solid-toggle-children').getByTestId('solid-children-content')
    2) <div data-testid="solid-children-content" data-hk="ix-SolidChildrenShowcase-71">…</div> aka getByTestId('cross-solid-react-children').getByTestId('solid-children-content')
    3) <div data-testid="solid-children-content" data-hk="ix-SolidChildrenShowcase-81">…</div> aka getByTestId('three-level-children').getByTestId('solid-children-content')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByTestId('solid-children-content')
